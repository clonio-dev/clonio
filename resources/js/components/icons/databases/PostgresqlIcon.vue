...
<template>
    ...
    >
        ...
        >
            ...
            />
            <path
                d="M221.73 286.084c-1.386 49.516.347 99.377 5.192 111.495 4.848 12.118 15.223 35.688 50.9 28.045 29.806-6.39 40.651-18.756 45.357-46.05 3.466-20.083 10.148-75.855 11.005-87.282M178.967 37.856S17.447-28.16 24.955 121.966c1.597 31.937 45.78 241.663 98.473 178.315 19.256-23.166 36.671-41.335 36.671-41.335M266.212 25.807C260.622 27.56 356.06-9.082 410.3 60.224c19.16 24.484-3.043 124.52-56.153 203.33"
            />
            <path
            ...
            />
            <path
                d="M194.467 273.934c-13.577 15.166-9.584 17.83-36.723 23.417-27.459 5.66-11.326 15.733-.797 18.365 12.768 3.195 42.307 7.718 62.266-20.229 6.078-8.509-.036-22.086-8.385-25.547-4.034-1.67-9.428-3.765-16.36 3.994z"
            />
            <path
                d="M193.578 273.67c-1.368-8.918 2.93-19.529 7.536-31.943 6.922-18.626 22.893-37.255 10.117-96.339-9.523-44.029-73.396-9.163-73.436-3.193-.039 5.968 2.89 30.26-1.067 58.548-5.162 36.913 23.488 68.132 56.48 64.938"
            />
            <path
            ...
            />
            <path
                d="M356.54 123.032c.862 15.994-3.446 26.888-3.989 43.914-.804 24.748 11.8 53.074-7.19 81.435"
            />
        </g>
    </svg>
</template>
