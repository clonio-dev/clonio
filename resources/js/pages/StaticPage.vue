...
<template>
    ...
    >
        ...
        <footer
            class="mt-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl"
        >
            <div class="flex items-center justify-between">
                <div
                    class="text-center text-sm text-gray-500 sm:text-left dark:text-gray-400"
                >
                ...
                <nav
                    class="ml-4 text-center text-sm text-gray-500 sm:ml-0 sm:text-right dark:text-gray-400"
                >
