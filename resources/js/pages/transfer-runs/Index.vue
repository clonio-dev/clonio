...
import type { RunStatus, TransferRun } from '@/types/transfer-run.types';
...
function getStatusConfig(status: RunStatus) {
    return statusConfig[status] || statusConfig.cancelled;
}

function isActiveRun(run: TransferRun): boolean {
...
function formatDuration(run: TransferRun): string {
        ...
        <div class="px-6 py-8 lg:px-8">
            ...
            <div class="mb-8 flex items-start justify-between">
                <div class="space-y-1">
                    ...
                    <p class="text-sm text-muted-foreground">
                        View and manage all your data transfer runs
                    </p>
                </div>
            ...
            >
                ...
                <span class="text-sm text-muted-foreground">
                    Showing {{ runs.from }}-{{ runs.to }} of {{ totalRuns }}
                </span>
            </div>
