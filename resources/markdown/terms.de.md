...
clonio.dev (Clonio) ist eine Applikation mit deren Hilfe produktive Daten ins Test- und Entwicklungssystem datenschutzkonform überführt werden können. Die Applikation wird nicht im Internet betrieben.
...
4. Für bestimmte Anwendungen innerhalb der Plattform kann es notwendig werden, dass Clonio zusätzlich Besondere
   ...
   Vereinbarung BesGB wird Clonio den Nutzer selbstverständlich rechtzeitig vor der Nutzung hinweisen.
5. Soweit Dritte (nachfolgend "Partnerunternehmen") über die Plattform von Clonio den Nutzern Dienste anbieten, sind
   für diese Dienste allein die jeweiligen Partnerunternehmen verantwortlich. Clonio wird den Nutzer rechtzeitig vor
...
1. Gegenstand dieses Vertrages ist die Zurverfügungstellung der Plattform zum datenschutzkonformen Kopieren von Produktionsdatenbanken in Entwicklungssysteme.
2. Die Nutzung der Plattform ist kostenlos für nicht-kommerzielle Benutzung. Der Funktionsumfang ist für alle Benutzer identisch und hängt nicht von einer Lizenz ab.
3. Clonio bietet abhängig vom Geschäftsergebnis und damit der Größe eines Unternehmens 2 verschiedene Lizenzgebühren an. Die aktuellen Preise entnehmen sie [https://clonio.dev/#pricing](/#pricing). Die Lizenz ist eine Fair-Use Lizenz und dient der Finanzierung der Weiterentwicklung von Clonio.
4. Die Anbindung des Nutzers an das Internet, die Aufrechterhaltung der Netzverbindung sowie die Beschaffung und
   ...
   tragen.
5. Clonio wird vom Kunden eigenständig in seinem eigenen Rechenzentrum betrieben. Wir, als Anbieter der Lösung, sind nicht in den Betrieb und damit verbundene Pflichten einbezogen.

## §3 Rechte und Pflichten des Nutzers

1. Um Clonio in vollem Umfang nutzen zu können, benötigt der Nutzer ein Clonio Konto. Dies ist allerdings nicht auf unserer angebotenen Webseite, sondern in der beim Benutzer betriebenen Instanz. Insofern haben wir keine Rechte und Pflichten in diesem Zusammenhang.
2. Da Clonio eine Fair-Use Lizenz für den kommerziellen Einsatz im Unternehmen bereitstellt, wird um eine faire Berücksichtigung dieser gebeten.
...
Clonio wird als Opensource Produkt entwickelt. Es kann jeder daran mitarbeiten und uneingeschränkt Einsicht in den Quellcode vornehmen. Zu finden unter https://github.com/clonio-dev/clonio

## §6 Haftungsfreistellung

1. Der Nutzer stellt Clonio von sämtlichen Ansprüchen, einschließlich Schadensersatzansprüchen, frei, die andere
   Nutzer oder sonstige Dritte, einschließlich Behörden ("Dritte"), gegen Clonio wegen einer Verletzung ihrer Rechte
   durch die von dem Nutzer in oder über das Clonio Konto eingestellten Inhalte geltend machen. Ferner stellt der
   Nutzer Clonio von sämtlichen Ansprüchen, einschließlich Schadensersatzansprüchen, frei, die andere Nutzer oder
   Dritte, gegen Clonio wegen der Verletzung ihrer Rechte durch rechtsverletzende oder falsche Angaben im oder über
   das Clonio Konto des Nutzers geltend machen. Der Nutzer übernimmt alle angemessenen Kosten, einschließlich der für
   die Rechtsverteidigung entstehenden angemessenen Kosten, die Clonio aufgrund einer Verletzung von Rechten anderer
   Nutzer oder Dritter durch den Nutzer entstehen. Alle weitergehenden Rechte sowie Schadensersatzansprüche von Clonio
   bleiben unberührt. Der Nutzer hat das Recht nachzuweisen, dass Clonio tatsächlich geringere Kosten entstanden sind.
...
## §7 Vergütung und Abrechnung von kommerzieller Nutzung

1. Für die kommerzielle Nutzung von Clonio wird ein Vertrag für eine unbefristete Zeit abgeschlossen. Der erste Zahlungszeitraum
   gilt dabei als Mindestvertragslaufzeit (jährlich entspricht 1 Jahr).
2. Die Vergütung der kommerziellen Nutzung erfolgt wiederholend (jährlich) durch
   den Nutzer an Clonio und bemisst sich an den jeweiligen Preisen, welche auf der
   Internetseite [https://clonio.dev/#pricing](/#pricing) abrufbar sind.
3. Falls Nutzer zu einem anderen Tarif wechseln, wird dies nicht die Beendigung des Vertrages begründen, sondern
   eine Vertragsänderung. Die Zahlungskonditionen und Rechte werden auf den neuen Tarif angepasst.
4. Sollte der Vertrag nicht vor Ablauf der vereinbarten Mindestvertragslaufzeit durch Kündigung beendet werden, verlängert sich die Laufzeit um die ursprünglich vereinbarte
   Mindestlaufzeit.
5. Gleichermaßen wird die jährliche Zahlung an dem Tag fällig, an dem der Nutzer eine Lizenz erworben hat und
   fortan an diesem Tag in jedem folgenden Jahr im Voraus.
6. Alle genannten Vergütungen und Preise verstehen sich jeweils wie ausgezeichnet. Das Angebot von Clonio richtet sich
...
7. Die Rechnungsstellung erfolgt elektronisch. Der Nutzer stimmt der elektronischen Rechnungsstellung ausdrücklich zu.
   ...
   widerrufen. Für diesen Fall behält Clonio sich das Recht vor, den Vertrag zur Nutzung der Plattform unverzüglich zu
   beenden.
8. Der Nutzer kann Forderungen aus diesem Vertrag nur mit schriftlicher Zustimmung von Clonio an Dritte abtreten.

## §8 Verzug

1. Gerät der Nutzer mit den Zahlungen für eine Lizenz innerhalb dieses Vertrages in Verzug, behält Clonio sich
   vor, den Zugang zu der Clonio Plattform zu untersagen. Der Nutzer bleibt in diesem Fall verpflichtet, die offenen
   Vergütungen zu zahlen. Die Sperrung wird erst wieder aufgehoben, wenn der Nutzer die Zahlung nachholt.
2. Die Geltendmachung weiterer Ansprüche wegen Zahlungsverzugs bleibt Clonio vorbehalten.

## §9 Laufzeit, Kündigung

1. Dieser Vertrag für die Lizenz für die kommerzielle Nutzung wird auf unbestimmte Zeit geschlossen.
2. Der Vertrag für die Lizenz für die kommerzielle Nutzung kann jederzeit gekündigt werden.
3. Kündigungen sind per E-Mail zu senden.
4. Im Fall einer vorfristigen Kündigung des Vertrages für die Lizenz zur kommerziellen Nutzung erfolgt eine Rückzahlung für Nichtnutzung innerhalb von 30 Tagen.

## §10 Haftung für Mängel

1. Für Mängel der vertragsgegenständlichen Leistungen haftet Clonio ausschließlich nach Maßgabe des §10 dieser AGB.
...
3. Der Nutzer wird Clonio unverzüglich über jegliche Mängel per E-Mail informieren.
4. Der Nutzer wird Clonio bei der Beseitigung der Mängel unentgeltlich unterstützen und insbesondere alle notwendigen
   Informationen, Dokumente etc. zur Verfügung stellen, die Clonio zu Analyse und Beseitigung der Mängel benötigt.
5. Ein Anspruch des Nutzers auf Schadensersatz wegen eines bei Vertragsschluss vorhandenen oder später eintretenden
   Mangels an der Software, wegen eines Umstandes den Clonio nicht zu vertreten hat, besteht nicht.
6. Es handelt sich bei Clonio um Opensource Software. Der Nutzer hat vor der Verwendung von Clonio Prüfpflichten zu erfüllen, die sicherstellen, dass keine Probleme beim Gebrauch auftreten.

## §11 Haftung

1. Für die Nutzung von Clonio ist die Haftung von Clonio auf Vorsatz und auf grobe Fahrlässigkeit
   oder Fehlen einer garantierten Eigenschaft beschränkt. Bei Vorsatz haftet Clonio in voller Höhe, bei grober
...
2. Es handelt sich bei Clonio um Opensource Software. Der Nutzer hat vor der Verwendung von Clonio Prüfpflichten zu erfüllen, die sicherstellen, dass keine Probleme beim Gebrauch auftreten.

## §12 Mitteilungen, Rechtsverletzungen

1. Erklärungen oder Mitteilungen an die Nutzer macht Clonio über die Plattform bekannt bzw. sendet diese per E-Mail an
   den Nutzer.
2. Verletzungen der Urheberrechte eines Nutzers sollte dieser bitte der Rechtsabteilung von Clonio melden. Dabei
   bittet Clonio um die Zurverfügungstellung folgender Informationen:
    ...
    6. eine eidesstattliche Versicherung von ihnen, dass die obigen Informationen wahrheitsgemäß sind und dass sie
       ...
       <br><br>Sie können die Rechtsabteilung per Email erreichen unter info@clonio.dev.
...
Widerrufs. Der Widerruf ist zu richten an: Robert Kummer IT, Hohenstaufenstraße 35, 10779 Berlin, info@clonio.dev
...
2. Hat der Nutzer, der Verbraucher ist, keinen Wohnsitz in Deutschland oder in einem anderen EU-Mitgliedsstaat oder hat
   ...
   Gerichtsstand für sämtliche Streitigkeiten aus diesem Vertrag der Sitz von Clonio.
...
4. Sollten einzelne Bestimmungen dieser AGB unwirksam sein oder werden und/oder den gesetzlichen Regelungen
   ...
   Regelungslücken.
5. Clonio behält sich vor, diese AGB, mit Ausnahme solcher Klauseln die Hauptleistungspflichten betreffen, zu ändern.
   Der Nutzer kann die aktuelle Version der AGB jederzeit über info@clonio.dev anfordern oder unter der folgenden URL
   abrufen https://clonio.dev/terms-of-service
6. Die Nutzer werden spätestens einen Monat vor dem geplanten Inkrafttreten der neuen Fassung der AGB per E-Mail auf die
   ...
   Inkrafttreten, so gelten die neuen AGB als akzeptiert. Clonio wird die Nutzer auf die Bedeutung der 1-Monatsfrist
   und des Widerspruchsrechts sowie die Rechtsfolgen des Schweigens gesondert in geeigneter Form hinweisen. Clonio
