-- =============================================================================
-- Clonio Test Dump: PostgreSQL Source Database
-- Usage: psql -U postgres -f tests/dumps/pgsql_source.sql
-- =============================================================================

DROP DATABASE IF EXISTS clonio_test_source;
CREATE DATABASE clonio_test_source ENCODING 'UTF8';
\connect clonio_test_source

-- -----------------------------------------------------------------------------
-- Schema
-- NOTE: No unique constraint on email (intentional — mirrors the MySQL baseline
--       so cross-DBMS comparisons stay consistent).
-- -----------------------------------------------------------------------------
